...
#ifndef HM_PROJECT_TURRET_N_H
#define HM_PROJECT_TURRET_N_H
...
class turret_N : public Actor_Class{
    Config conf;

public:
    sf::RectangleShape turretsN;
    turret_N(sf::RenderWindow& window, Collision col, int xInn, int yInn); //Henter inn referanse til vindu for å unngå å lage et nytt vindu for hver state.
