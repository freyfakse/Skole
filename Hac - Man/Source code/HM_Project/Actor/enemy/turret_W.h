...
#ifndef HM_PROJECT_TURRET_W_H
#define HM_PROJECT_TURRET_W_H
...
class turret_W : public Actor_Class{
    Config conf;

public:
    sf::RectangleShape turretsW;
    turret_W(sf::RenderWindow& window, Collision col, int xInn, int yInn); //Henter inn referanse til vindu for å unngå å lage et nytt vindu for hver state.
