...
#ifndef HM_PROJECT_TURRET_E_H
#define HM_PROJECT_TURRET_E_H
...
class turret_E : public Actor_Class {
    Config conf;

public:
    sf::RectangleShape turretsE;

    turret_E(sf::RenderWindow &window, Collision col, int xInn,
             int yInn); //Henter inn referanse til vindu for å unngå å lage et nytt vindu for hver state.
