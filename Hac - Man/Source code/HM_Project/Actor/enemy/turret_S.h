...
#ifndef HM_PROJECT_TURRET_S_H
#define HM_PROJECT_TURRET_S_H
...
class turret_S : public Actor_Class{
    Config conf;

public:
    sf::RectangleShape turretsS;
    animatonsprites animation;
    turret_S(sf::RenderWindow& window, Collision col, int xInn, int yInn); //Henter inn referanse til vindu for å unngå å lage et nytt vindu for hver state.
