...
#ifndef HM_PROJECT_TURRET_ALL_H
#define HM_PROJECT_TURRET_ALL_H
...
class turret_all : public Actor_Class{
    Config conf;

public:
    sf::RectangleShape turretsAll;
    turret_all(sf::RenderWindow& window, Collision col, int xInn, int yInn); //Henter inn referanse til vindu for å unngå å lage et nytt vindu for hver state.
