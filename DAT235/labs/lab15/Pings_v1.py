...
host = "127.0.0.1"          #  MQTT broker host address

capath = "/home/pi/.local/share/mosquitto/cert"     #  Make sure the ca cert is there! 
cafile = "dat235ca.crt"         #


# definitions and intial data config
hello = "Secured Ping started (but no pw/acl)"
goodbye = "Pings ended"
